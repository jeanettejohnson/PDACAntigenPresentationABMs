...
make_scatter(
    ...
    out_path = Path(__file__).parent / "analysis/apcaf_vs_tcells_ic.png",
)
...
make_scatter(
    ...
    out_path = Path(__file__).parent / "analysis/caf_vs_tcells_ic.png",
)
...
make_scatter(
    ...
    out_path = Path(__file__).parent / "analysis/caf_vs_apcaf_ic.png",
)
...
make_scatter(
    ...
    out_path = Path(__file__).parent / "analysis/epi_vs_mes_tumor_ic.png",
)
...
make_scatter(
    ...
    out_path = Path(__file__).parent / "analysis/apcaf_vs_cd8_ic.png",
)
...
make_scatter(
    ...
    out_path = Path(__file__).parent / "analysis/apcaf_vs_cd4_ic.png",
)
...
make_scatter(
    ...
    out_path = Path(__file__).parent / "analysis/class1_vs_class1class2_ic.png",
)
