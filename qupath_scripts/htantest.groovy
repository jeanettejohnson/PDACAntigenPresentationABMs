...
def modelPath = "/Users/jeanette.johnson/models/stardist/dsb2018_paper.pb"
...
//          .downsample(1)         // Optional alternative to maxDimension to use the full-resolution image for normalization
    ...
    .channels('Histone H3')            // Select detection channel (usually useful for fluorescence, not needed for RGB);
